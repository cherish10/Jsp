    ...
    <section class="cate5">
        <aside>
            ...
            <ul class="lnb">
                ...
                <li class="${cate eq 'fnq' ? 'on' : 'off'}"><a href="/Farmstory2/board/list.do?group=community&cate=fnq">자주묻는질문</a></li>
            </ul>

        </aside>
        <article>
            <nav>
                <c:if test="${cate eq 'notice'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit1.png" alt="공지사항"/></c:if>
            	<c:if test="${cate eq 'menu'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit2.png" alt="오늘의식단"/></c:if>
            	<c:if test="${cate eq 'chef'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit3.png" alt="나도요리사"/></c:if>
            	<c:if test="${cate eq 'qna'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit4.png" alt="고객문의"/></c:if>
            	<c:if test="${cate eq 'faq'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit5.png" alt="자주묻는질문"/></c:if>
                ...
                <p>
                    ...
                    <c:if test="${cate eq 'fnq' }"><em>자주묻는질문</em></c:if>
