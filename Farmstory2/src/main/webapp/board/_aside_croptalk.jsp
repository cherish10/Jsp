    ...
    <section class="cate3">
        ...
        <article>
            <nav>
                ...
                <c:if test="${cate eq 'grow'}"><img src="/Farmstory2/img/sub_nav_tit_cate3_tit2.png" alt="텃밭가꾸기"/></c:if>
                <c:if test="${cate eq 'school'}"><img src="/Farmstory2/img/sub_nav_tit_cate3_tit3.png" alt="귀농학교"/></c:if>
                <p>
                    HOME > 농작물이야기 > 
