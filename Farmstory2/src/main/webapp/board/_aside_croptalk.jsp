...
<div id="sub">
    ...
    <section class="cate3">
        <aside>
            ...
            <ul class="lnb">
                <li class="on"><a href="/Farmstory2/board/list.do?group=croptalk">농작물이야기</a></li>
                <li><a href="/Farmstory2/board/list.do?group=croptalk">텃밭가꾸기</a></li>
                <li><a href="/Farmstory2/board/list.do?group=croptalk">귀농학교</a></li>
            </ul>
