...
<div id="sub">
    ...
    <section class="cate3">
        <aside>
            ...
            <ul class="lnb">
                <li class="on"><a href="/Farmstory1/board/list.jsp">농작물이야기</a></li>
                <li class="on"><a href="/Farmstory1/board/list.jsp">텃밭가꾸기</a></li>
                <li class="on"><a href="/Farmstory1/board/list.jsp">귀농학교</a></li>
            </ul>
